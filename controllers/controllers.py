...
class IndicatorDashboard(http.Controller):
    ...
    @http.route('/cuadro_de_mando/model_fields', type='json', auth='user')
    ...
    @http.route('/cuadro_de_mando/indicator_query', type='json', auth='user')
    ...
    @http.route('/cuadro_de_mando/group_query', type='json', auth='user')
    ...
    @http.route('/cuadro_de_mando/create_indicator', type='json', auth='user')
    ...
    @http.route('/cuadro_de_mando/retrieve_indicator', type='json', auth='user')
